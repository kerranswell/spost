...
//            var link = '<a href="' + settings.imageArray[settings.activeImage][0] + '" target="_blank">Скачать</a>';
            var link = '';
			// If we have a image set, display 'Image X of X'
			if ( settings.imageArray.length > 1 ) {
				$('#lightbox-image-details-currentNumber').html(settings.txtImage + ' ' + ( settings.activeImage + 1 ) + ' ' + settings.txtOf + ' ' + settings.imageArray.length + '<br />' + link).show();
			} else {
                $('#lightbox-image-details-currentNumber').html(link).show();
            }
//            $('#lightbox-image-details-currentNumber a').click(function () {return false;});
		}
		/**
